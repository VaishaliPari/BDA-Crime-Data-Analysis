#Average of Temperature Humidity and windspeed for each Month
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: avg_weather.py <filtered_weather_dataset>", file=sys.stderr)
        exit(-1)
    sc = SparkContext()
    ...
    counts.saveAsTextFile("weather_average_monthly.out")
    sc.stop()
